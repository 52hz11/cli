...
var flagDefs = map[string]commandDef{
	...
	"+chart-config-update": {
		...
		Flags: []flagDef{
			...
			{Name: "data-label-position", Kind: "own", Type: "string", Required: "optional", Desc: "Pass only when the user explicitly requests a position; omit it for chart-type-aware data label placement", Enum: []string{"auto", "top", "bottom", "left", "right", "center", "inside", "outside"}},
